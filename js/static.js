...
angular.module('inform', []).controller('infoctrl', function($scope) {
    ...
    $scope.conference_email = "nydkconference@gmail.com",
    $scope.questions = [
        ...
        {ques:' Q. How much does the conference cost?',ans:'A. The conference costs $290.00 per Key Club Member, and $320 per Key Club Advisor or Chaperone (single rooms available for $640). This includes all conference costs.',ref:'a2',collapse:'collapse'},
        {ques:' Q. Is there a deadline for Registration?',ans:'A. Yes. The preferred/guaranteed registration deadline is February 27th, 2017. The final deadline for registration is March 10th, 2017. All payment must be sent in immediately after completing the registration form.',ref:'a3',collapse:'collapse'},
        ...
        {ques:' Q. My school administration requires an invoice, how can we receive one?',ans:'A. On your confirmation page, and in your confirmation email, you will see a link for “Invoice”. Contact nydkconference@gmail.com if you have any problems finding this document. The LTC Website also has a W-9 if your school requires one for payment.',ref:'a12',collapse:'collapse'},
        {ques:' Q. Who should I ask if I have other questions?',ans:'A. All questions can be directed to nydkconference@gmail.com. All questions will be answered in a timely manner.',ref:'a13',collapse:'collapse'}
    ];
});
