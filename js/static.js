...
angular.module('inform', []).controller('infoctrl', function($scope) {
    ...
    $scope.questions = [
        ...
        {ques:' Q. How much does the conference cost?',ans:'A. The conference costs $298.00 per Key Club Member, and $330 per Key Club Advisor or Chaperone (single rooms available for $649). This includes all conference costs.',ref:'a2',collapse:'collapse'},
        {ques:' Q. Is there a deadline for Registration?',ans:'A. Yes. The preferred/guaranteed registration deadline is February 22, 2019. The final deadline for registration is March 1, 2019. All payment must be sent in immediately after completing the registration form or no later than March 15, 2019.',ref:'a3',collapse:'collapse'},
